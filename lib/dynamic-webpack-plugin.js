...
function validateOptions(options){
    if(!options){
        throw new Error('DynamicWebpackPlugin: missing options !!');
    }
    if(!options.outputPath){
       throw new Error('DynamicWebpackPlugin: missing outputPath options');
    }
    if(!options.global){
        throw new Error('DynamicWebpackPlugin: missing global options');
    }
}
